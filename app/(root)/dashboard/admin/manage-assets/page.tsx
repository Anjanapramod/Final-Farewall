...
export default function ManageAssets() {
    ...
    const [funeralParlor] = useState<FuneralParlor>(
        localStorage.getItem("funeralParlor")
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            if (editMode && currentAssetId !== null) {
                // Update logic here if needed (you can update asset by dispatching the update action)
                console.log("Updating asset", currentAssetId);
            } else {
                ...
                if (funeralParlor && funeralParlor.id) {
                    ...
                    console.error("Funeral parlor data is missing.");
                }
            }
