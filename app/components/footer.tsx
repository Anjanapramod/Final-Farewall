      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-600">Connecting compassionate care with those in need.</p>
          </div>
          <div>
            <h4 className="text-md font-semibold mb-4">Quick Links</h4>
            <ul className="space-y-2">
              <li><Link href="#" className="text-gray-600 hover:text-gray-800">About Us</Link></li>
              <li><Link href="#" className="text-gray-600 hover:text-gray-800">For Funeral Homes</Link></li>
              <li><Link href="#" className="text-gray-600 hover:text-gray-800">For Families</Link></li>
        ...
        <div className="mt-8 pt-8 border-t border-gray-200 text-center">
          <p className="text-gray-600">&copy; {new Date().getFullYear()} Final Farewell. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
